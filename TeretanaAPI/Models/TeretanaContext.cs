        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Provides>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("FK__Provides__UserId__5812160E");
            });
            ...
            modelBuilder.Entity<Subscribed>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("FK__Subscribe__UserI__619B8048");
            });
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Users__1788CC4C24D13269");
            ...
            modelBuilder.Entity<Uses>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("FK__Uses__UserId__5441852A");
            });
        }
    }
}